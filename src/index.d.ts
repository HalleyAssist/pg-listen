...
declare function createPostgresSubscriber<Events extends Record<string, any> = {
    [channel: string]: any;
}>(connectionConfig?: pg.ClientConfig, options?: createPostgresSubscriber.Options): createPostgresSubscriber.Subscriber<Events>;

declare namespace createPostgresSubscriber {
    export interface PgParsedNotification {
        processId: number;
        channel: string;
        payload?: any;
    }
    export interface PgListenEvents {
        connected: () => void;
        error: (error: Error) => void;
        notification: (notification: PgParsedNotification) => void;
        reconnect: (attempt: number) => void;
    }
    export type EventsToEmitterHandlers<Events extends Record<string, any>> = {
...
export = createPostgresSubscriber;
